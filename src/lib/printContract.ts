...
export const CLAUSES: Clause[] = [
  {
    ...
    ar: 'يتم تسليم السيارة للمستأجر بحالة نظيفة وجاهزة وخالية من أي نقص. ويتعهد المستأجر بإرجاعها بنفس الحالة وفي الوقت والمكان المتفق عليه.',
  ...
  },
  {
    ...
    ar: 'تكون المسؤولية الكاملة عن السيارة على المستأجر طوال مدة الإيجار، ولا يجوز قيادة السيارة إلا من قبل الأشخاص المذكورين في العقد.',
  ...
  },
  {
    ...
    ar: 'جميع المخالفات المرورية، رسوم المواقف، أو أي عقوبات خلال فترة الإيجار تكون على المستأجر.',
  ...
  },
  {
    ...
    ar: 'أي ضرر غير مشمول بالتأمين يتحمله المستأجر بالكامل، كما يتحمل أيضاً قيمة نقصان سعر السيارة (انخفاض القيمة).',
  ...
  },
  {
    ...
    ar: 'يجب على المستأجر في حال وقوع حادث: إبلاغ الشركة فوراً، استخراج تقرير من الشرطة أو الدرك، وإجراء فحص الكحول. وفي حال عدم الالتزام، يتحمل المستأجر كامل المسؤولية.',
  ...
  },
  {
    ...
    ar: 'الحد اليومي 150 كم والحد الشهري 3500 كم. وفي حال التجاوز يتم احتساب رسوم إضافية لكل كيلومتر زائد.',
  ...
  },
  {
    ...
    ar: 'يمنع استخدام السيارة في الحالات التالية: الخروج بها خارج تركيا، استخدامها في السباقات أو الطرق الوعرة، استخدامها في أي نشاط مخالف للقانون.',
  ...
  },
  {
    ...
    ar: 'يجب إعادة السيارة بنفس مستوى الوقود الذي استلمها به، وفي حال النقص يتم احتساب الفرق على المستأجر.',
  ...
  },
  {
    ...
    ar: 'في حال تأخر المستأجر، يتم احتساب يوم إضافي مع غرامة. التأخير أكثر من ساعتين يُحسب يوم كامل.',
  ...
  },
  {
    ...
    ar: 'يتم استخدام مبلغ التأمين لتغطية أي أضرار أو مخالفات أو مبالغ غير مدفوعة، ويتم إعادة المتبقي إن وجد.',
  ...
  },
  {
    ...
    tr: 'Araç, GPS takip cihazı ve kaza kayıt kamerası ile donatılmış olabilir. Kiracı bunların kullanımını kabul eder.',
  ...
  },
  {
    ...
    ar: 'يلتزم المستأجر بدفع جميع المبالغ المستحقة، وفي حال عدم الدفع يتم اتخاذ إجراءات قانونية.',
...
<div class="page page-break">
  ...
  <div class="contract-title-block">
    <span class="contract-title-tr">ARA&Ccedil; K&#304;RALAMA S&Ouml;ZLE&Scedil;MES&#304;</span>
    ...
    <div class="contract-meta">
      S&ouml;zle&scedil;me No / Contract No: <strong>${booking.booking_number}</strong>
      &nbsp;&nbsp;&middot;&nbsp;&nbsp;
  ...
  <div class="info-grid">
    ...
    <div class="info-box">
      ...
      <table class="info-table">
        ...
        ${infoRow('S&#304;GORTA T&Uuml;R&Uuml;', 'Insurance Type', 'نوع التأمين', fmt(booking.insurance_type))}
    ...
    <div class="bono-body">
      ...
      <div class="bono-row-2">
        <div class="bono-amount-box">
          <div class="bono-amount-label">T&uuml;rk Liras&#305; (&#8378;) / Amount in Turkish Lira</div>
          <div class="bono-amount-val">&nbsp;</div>
          <div class="bono-words-label">Yaz&#305;yla / In Words:</div>
          <div class="bono-words-line"></div>
        </div>
        <div>
          <div class="bono-field-label">&Ouml;deme Yeri / Payment Location</div>
          <div class="bono-field-val">&nbsp;</div>
        </div>
      </div>
      ...
      <div class="bono-promise">
        Bu senedi d&uuml;zenleyen <span style="border-bottom:1px solid #374151;display:inline-block;min-width:160px;">&nbsp;</span>,
        yukar&#305;da belirtilen <strong>vade tarihinde</strong>,
        Homesta Cars&rsquo;a veya emrine,
        yukar&#305;da yaz&#305;l&#305; miktar&#305; kay&#305;ts&#305;z ve &scedil;arts&#305;z &ouml;deyece&gbreve;ini kabul ve taahhüt eder.
        İşbu bono, <span style="border-bottom:1px solid #374151;display:inline-block;min-width:120px;">&nbsp;</span> numaral&#305; ara&ccedil; kiralama s&ouml;zle&scedil;mesine istinaden d&uuml;zenlenmi&scedil;tir.
      </div>

      <!-- Debtor grid: name | TC (blank) | address (blank) | signature -->
      <div class="bono-debtor-grid">
        <div>
          <div class="bono-debtor-label">Bor&ccedil;lu Ad&#305; Soyad&#305;</div>
...
<div class="page">
  ...
  <div class="terms-header">
    ...
    <div class="terms-header-ref">
      <strong>S&ouml;zle&scedil;me No:</strong> ${booking.booking_number}<br/>
  ...
  <div class="footer-note">
    ...
    &nbsp;&middot;&nbsp;
    Bu s&ouml;zle&scedil;me elektronik ortamda olu&scedil;turulmu&scedil;tur / This contract was generated electronically.
    &nbsp;&middot;&nbsp;
