          ...
          return (
            <NavLink
              ...
              style={{
                ...
                color: isActive ? 'var(--sidebar-primary)' : 'rgb(0 0 0 / 0.55)',
                background: isActive
            ...
            >
              {isActive && (
                <div style={{
                  ...
                  width: 3, height: 14, borderRadius: '0 3px 3px 0', background: 'var(--sidebar-primary)',
                }} />
              )}
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" style={{ flexShrink: 0, color: isActive ? 'var(--sidebar-primary)' : 'rgb(0 0 0 / 0.40)' }}>
